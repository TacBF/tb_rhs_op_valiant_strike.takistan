class TacBF
{
        class Supply
        {
                ...
                class CargoCollections
                {
                        class statics_west {
                                transportClear = 1;
                                cargo[] = {{"RHS_M2StaticMG_D", 1, 3}, {"RHS_M252_D", 2, 6}, {"TB_Box_West_Mines_F", 2, 0}};
                        };
                        class statics_east {
                                transportClear = 1;
                                cargo[] = {{"rhsgref_ins_DSHKM", 1, 3}, {"rhs_2b14_82mm_msv", 2, 6}, {"RHS_ZU23_MSV", 0, 5}, {"TB_Box_East_Mines_F", 2, 0}};
                        };
